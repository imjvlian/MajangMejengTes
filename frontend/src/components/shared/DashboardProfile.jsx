    ...
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <div className="text-red-500 flex justify-between mt-5 ">
        <AlertDialog>
          ...
          <AlertDialogContent className="bg-accent rounded-2xl m-auto">
            <AlertDialogHeader>
              <AlertDialogTitle className="m-auto font-bold">
                Are you sure?
              </AlertDialogTitle>

              <AlertDialogDescription className="m-auto items-center px-1">
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction onClick={handleDeleteUser}>
                <Button variant="ghost" className="bg-red-600 text-white">
                  Continue
                </Button>
              </AlertDialogAction>
            </AlertDialogFooter>
