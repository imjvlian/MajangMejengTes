...
const DashboardSidebar = () => {
  ...
  return (
    <aside className="h-screen w-64 dark:bg-slate-800 dark:text-slate-200 bg-slate-200 text-slate-800 flex flex-col">
      {/* Logo/ Header */}
      <div className="p-4 flex items-center justify-center bg-slate-200 dark:bg-slate-800 dark:text-slate-200">
